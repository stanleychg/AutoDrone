...
//    protected DJILBAirLink.DJIOnReceivedVideoCallback mOnReceivedVideoCallback = null;
    ...
    //Jesse's Alg
    private RealSizeManager mSizeManager = null;
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mSizeManager = RealSizeManager.getInstance();
    ...
    /**
     * Prepare live video stream on fragment layout
     */
    ...
    public void onSurfaceTextureUpdated(SurfaceTexture surface) {
        ...
        Scalar lowerBound = new Scalar(23,100,100);
        Scalar upperBound = new Scalar(255,255,30);
//        Scalar lowerBound = new Scalar(100,100,23);
//        Scalar upperBound = new Scalar(255,255,30);
//        Scalar lowerBound = new Scalar(60,77,39);
//        Scalar upperBound = new Scalar(60,88,100);
        ...
        for(MatOfPoint c: contours){
            ...
            if(rWidth > 100 || rHeight > 100){
                ...
                for(MatOfPoint c2: contours){
                    ...
                    if(r2.width <40 || r2.height<40) continue;
                    if(r.width <40 || r.height<40) continue;
                    if(Math.sqrt(Math.pow(r2.width-r.width,2) + Math.pow(r2.height - r.height,2)) < 10){
                        Imgproc.rectangle(rawOutput,
                                new Point(x,y),
                                new Point(x+rWidth, y+rHeight),
                                new Scalar(new double[]{255,255,255}),
